...
async fn temp_service(_: Request<Body>, rx: Arc<Mutex<Vec<i16>>>) -> Result<Response<Body>, Infallible> {
    ...
    Result::<Response<Body>, Infallible>::Ok(Response::new(Body::from(payload)))
}
